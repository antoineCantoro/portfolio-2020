...
export default {
  data() {
    return {
      enableLegalNotice: false 
    }
  },
  methods: {
      animations: function(el) {
        console.log(el)
        let animation = el.getAttribute("animation-name")

        if (animation === "quote") {
            console.log("Quote Anim")
